...
(function($) { // Hide scope, no $ conflict
 ...
 $(selector).datepick('setDate', [date1, date2, date3]) */
		...
		_generateMonthSelection: function(inst, year, month, minDate, maxDate, monthHeader, calendar) {
			...
			var selector = '<select class="form-control ' + this._monthYearClass +
			...
			if (yearRange === 'any') {
				selector = '<select class="form-control ' + this._monthYearClass + ' ' + this._anyYearClass +
				...
				selector = '<select class="form-control ' + this._monthYearClass +
					'" title="' + inst.options.yearStatus + '">';
