...
$.localise = function(packages, settings, loadBase, path, timeout, async, complete) {
	...
	var lang = normaliseLang(getSystemLocale());
...
// Localise it!
$.localize = $.localise('messages',{path: getContextPath()+'/static-resources/neutrino/neutrino-common/js/localization/'});

/* Retrieve the default language set for the browser. */
$.localise.defaultLanguage = normaliseLang(getSystemLocale());
