	...
	multiselect = {
		init: function(){
			...
			$('.multiselect').multiSelect({
				...
				selectionHeader		: '<h4>Selected Items</h4>'
			});
			...
			$('#searchable-form').multiSelect({
				selectableHeader : '<input  class="form-control " type="text" id="multi_search" autocomplete="off" placeholder="search" />',
				selectionHeader	 : '<a href="javascript:void(0)" id="sForm_deselect" class="btn">Deselect All</a>'
			});
